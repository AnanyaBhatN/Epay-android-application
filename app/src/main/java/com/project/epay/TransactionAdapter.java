...
//
//        holder.tvTitle.setText(getTitleText(transaction));
...
//        holder.tvDetailDateTime.setText("Date & Time: " + transaction.getDate() + " " + transaction.getTime());
...
//    }
//
//    private String getTitleText(Transaction transaction) {
//        switch (transaction.getType()) {
//            case RECHARGE:
//                return "Recharge to " + transaction.getCounterpart();
//            case PAID:
//                return "Paid to " + transaction.getCounterpart();
//            case RECEIVED:
//                return "Received from " + transaction.getCounterpart();
//            case SENDMONEY:
//                return "Sent to " + transaction.getCounterpart(); // for Send Money
//            default:
//                return "";
//        }
//    }
...
public class TransactionAdapter extends RecyclerView.Adapter<TransactionAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Set color: red for Recharge & Sent, green for Received
